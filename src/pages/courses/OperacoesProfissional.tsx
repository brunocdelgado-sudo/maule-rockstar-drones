...
const OperacoesProfissional = () => {
  const course = coursesData.find(c => c.slug === "operacoes-profissional")!;
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h2 className="text-foreground">Pronto Para Se Tornar um Profissional?</h2>
...
export default OperacoesProfissional;
