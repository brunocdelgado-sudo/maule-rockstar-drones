...
const SegurancaDrones = () => {
  const course = coursesData.find(c => c.slug === "seguranca-drones")!;
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h2 className="text-foreground">Pronto Para Atuar em Segurança?</h2>
...
export default SegurancaDrones;
